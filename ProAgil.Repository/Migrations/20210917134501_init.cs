    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OradoresEventos", x => new { x.EventoId, x.OradorId });
                    table.ForeignKey(
                        name: "FK_OradoresEventos_Eventos_EventoId",
                        column: x => x.EventoId,
                        principalTable: "Eventos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OradoresEventos_Oradores_OradorId",
                        column: x => x.OradorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OradoresEventos_OradorId",
                table: "OradoresEventos",
                column: "OradorId");
